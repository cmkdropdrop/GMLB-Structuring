...
* Jahresgitter: Crediting, Gebuehren (ein Jahresfaktor statt ACT/365F-
  ...
  archivierten policy_engine.lsmc.
...
from policy_engine.esg import Measure, STEPS_PER_YEAR, simulate  # noqa: E402
from policy_engine.product import (  # noqa: E402
    Index,
    SpouseDeathElection,
)
...
LOGGER_NAME = "policy_engine.lsmc_crediting_cap_runner"
        ...
        manifest = {
            ...
            "method": {
                ...
                "annual_grid_approximations": [
                    ...
                    "archived policy_engine.lsmc (fees as one annual factor, "
