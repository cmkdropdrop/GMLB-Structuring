...
around the existing ``CapitalStresses`` research defaults.  They are suitable for
paired Dynamic-Behaviour and LSMC revaluations; they are not a complete
regulatory capital specification and intentionally contain no lapse stress.
"""
...
PORTFOLIO_STRESS_DEFINITION_VERSION = "1.0"
