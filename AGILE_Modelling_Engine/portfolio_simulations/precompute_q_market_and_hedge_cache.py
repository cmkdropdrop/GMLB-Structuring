...
exact-cache mismatch when cache use is required.
"""
...
from agile_engine.mortality import MortalityTable  # noqa: E402
...
DEFAULT_MARKET_CACHE_ROOT = Path(__file__).resolve().parent / "cache" / "q_market_paths"
DEFAULT_HEDGE_CACHE_ROOT = Path(__file__).resolve().parent / "cache" / "q_hedge_prices"
...
def parse_args(argv: Optional[Sequence[str]] = None) -> argparse.Namespace:
    ...
    if args.cross_fit_folds < 2 or args.n_paths <= args.cross_fit_folds:
