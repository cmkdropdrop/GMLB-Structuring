...
The loader deliberately consumes only the two versioned CSV sources under
``input_data/market_data``.  It maps every supported row to an
:class:`~policy_engine.esg.ESGConfig` and retains file-level provenance for
