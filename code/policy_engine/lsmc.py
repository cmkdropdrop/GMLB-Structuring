...
in :mod:`policy_engine.behavior`; do not use this module for base-case results.

Worst-case (rational-exercise) valuation of the legacy source contract following
